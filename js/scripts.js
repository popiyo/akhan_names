...
if(candidateEnglishName){
      ...
      if(yearOfBirth)  {
        operationCancelled = false; //successfully caputured all data
...
//operations only continue if there was no cancellation
